...
// // Define the FormUrlQueryParams type
...
// // Define the RemoveUrlQueryParams type
...
//   // Convert URLSearchParams to a string before parsing
...
// Import aspectRatioOptions from the correct module
import { aspectRatioOptions } from "@/constants";

// Define AspectRatioKey based on aspectRatioOptions
export type AspectRatioKey = keyof typeof aspectRatioOptions;
...
// Image interface with AspectRatioKey
interface Image {
...
// Image size calculation function
export const getImageSize = (
  type: string,
  image: Image,
  dimension: "width" | "height"
...
export const deepMergeObjects = (obj1: AnyObject, obj2: AnyObject) => {
  if (obj2 === null || obj2 === undefined) return obj1;

  let output: AnyObject = { ...obj2 };
